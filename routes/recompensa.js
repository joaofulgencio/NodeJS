...
// Utilizar recompensa.
router.patch('/utilizar/:id_recompensa', async (req, res, next) => {
    try {
        let recompensaUtilizada = await req.container.utilizarRecompensaUseCase.execute(req.params.id_recompensa)
